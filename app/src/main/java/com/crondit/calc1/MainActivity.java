...
import com.crondit.calc1.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnMlt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                computeCalculation();
        ...
        binding.btnEqvl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                computeCalculation();
        ...
        binding.btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if (binding.etEditText.getText().length()>0){
                   ...
                   binding.etEditText
                           .setText(currentText.subSequence(0,currentText.length()-1));
               }
               else {
                   valueOne=Double.NaN;
                   valueTwo=Double.NaN;
